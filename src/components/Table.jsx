...
export default function Table({ jobs, columns, groupBy, onOpenJob, onAddJob, onMoveJob }) {
    ...
    // applyFilters already sorted; Table has a secondary sort via column headers
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "16px 20px" }}>
            <div style={{
                ...
                <div style={{
                    ...
                    <button
                        onClick={onAddJob}
                        style={{ fontSize: 12, padding: "5px 12px", borderRadius: 7, border: "1px solid var(--border-default)", background: "transparent", color: "var(--text-secondary)", cursor: "pointer" }}
                            ...
                            {sorted.length === 0 ? (
                                <tr>
                                    <td colSpan={COLS.length} style={{ ...tdStyle, textAlign: "center", padding: "32px", color: "var(--text-tertiary)" }}>
                                        ...
                                        <button onClick={onAddJob} style={{ color: "var(--accent)", background: "none", border: "none", cursor: "pointer", fontSize: 13 }}>
                                            Add one →
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <Fragment key={group.key}>
                                    {isGrouped && (
                                        <tr aria-label={`Group: ${group.label}`}>
